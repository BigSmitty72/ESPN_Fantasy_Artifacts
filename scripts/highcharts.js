...
(function (K, a) {
	...
	(function (a) {
		...
		a.Fx.prototype = {
			dSetter : function () {
				...
				if (1 === m)
					...
					for (; r--; )
						n = parseFloat(a[r]), d[r] = isNaN(n) ? a[r] : m * parseFloat(g[r] - n) + n;
				else
					d = g;
				this.elem.attr("d", d)
			},
			update : function () {
				...
				if (this[g + "Setter"])
					...
					a.attr ? a.element && a.attr(g, d) : a.style[g] = d +
						this.unit;
				m && m.call(a, d, this)
			},
			run : function (a, g, d) {
			...
			step : function (a) {
				...
				if (d.attr && !d.element)
					...
					this.pos = m.easing((g - this.startTime) / n), this.now = this.start + (this.end - this.start) * this.pos, this.update(), d = !0;
				return d
			},
			initPath : function (t, g, d) {
				...
				function n(a, f) {
					for (var b = (e - a.length) / B; 0 < b && b--; )
						c = a.slice().splice(a.length / h - B, B * h), c[0] = f[e - B - b * B], v && (c[B - 6] = c[B - 2], c[B - 5] = c[B - 1]), [].splice.apply(a, [a.length / h, 0].concat(c)), q && b--
				}
				g = g || "";
				var p,
				b = t.startX,
		...
		a.merge = function () {
			...
			r = function (n, d) {
				...
				"object" !== typeof n && (n = {});
				for (k in d)
					d.hasOwnProperty(k) && (b = d[k], a.isObject(b, !0) && "renderTo" !== k && "number" !== typeof b.nodeType ? n[k] = r(n[k] || {}, b) : n[k] = d[k]);
				return n
			};
		...
		function (t, g, d) {
			...
			r;
			if (a.isString(g))
				a.defined(d) ? t.setAttribute(g, d) : t && t.getAttribute && (r = t.getAttribute(g));
			else if (a.defined(g) && a.isObject(g))
				for (m in g)
					t.setAttribute(m, g[m]);
			return r
		};
		a.splat = function (t) {
		...
		a.dateFormat = function (t, g, d) {
			...
			for (n in m)
				for (; -1 !== t.indexOf("%" + n); )
					t = t.replace("%" + n, "function" === typeof m[n] ? m[n](g) : m[n]);
		...
		a.destroyObjectProperties = function (a, g) {
			for (var d in a)
				a[d] && a[d] !== g && a[d].destroy && a[d].destroy(), delete a[d]
		};
		...
		a.map = function (a, g) {
			for (var d = [], m = 0, r = a.length; m < r; m++)
				d[m] = g.call(a[m], a[m], m, a);
			return d
		};
		a.offset = function (a) {
		...
		a.fireEvent = function (t, g, d, m) {
			...
			p;
			d = d || {};
			if (E.createEvent && (t.dispatchEvent || t.fireEvent))
				r = E.createEvent("Events"), r.initEvent(g, !0, !0), a.extend(r, d), t.dispatchEvent ?
				...
				for (r = r[g] || [], n = r.length, d.target || a.extend(d, {
					...
					(p = r[g]) && !1 === p.call(t, d) && d.preventDefault();
		...
		a.animate = function (t, g, d) {
			...
			d.curAnim = a.merge(g);
			for (b in g)
				p = new a.Fx(t, d, b), n = null, "d" === b ? (p.paths = p.initPath(t, t.d, g.d), p.toD = g.d, m = 0, n = 1) : t.attr ? m = t.attr(b) : (m = parseFloat(a.getStyle(t, b)) || 0, "opacity" !== b && (r = "px")), n || (n = g[b]), n.match && n.match("px") && (n = n.replace(/px/g, "")), p.run(m, n, r)
		};
		...
		(G.jQuery.fn.highcharts = function () {
			...
			if (this[0])
				return t[0] ? (new(a[a.isString(t[0]) ? t.shift() : "Chart"])(this[0], t[0], t[1]), this) : y[a.attr(this[0], "data-highcharts-chart")]
		});
		E && !E.defaultView && (a.getStyle = function (t, g) {
			...
			[g];
			if (t.style[g])
				return a.pInt(t.style[g]);
			"opacity" === g && (g = "filter");
			if (d)
				return t.style.zoom = 1, Math.max(t[d] - 2 * a.getStyle(t, "padding"), 0);
		...
		a.Color.prototype = {
			...
			init : function (g) {
				...
				if ((this.input = g = this.names[g] || g) && g.stops)
					this.stops = E(g.stops, function (d) {
							return new a.Color(d[1])
						});
				else
					for (r = this.parsers.length; r-- && !m; )
						n = this.parsers[r], (d = n.regex.exec(g)) && (m = n.parse(d));
				this.rgba = m || []
			},
			get : function (a) {
				var d = this.input,
			...
			brighten : function (a) {
				...
				m = this.rgba;
				if (this.stops)
					A(this.stops, function (d) {
						d.brighten(a)
					});
				else if (y(a) && 0 !== a)
					for (d = 0; 3 > d; d++)
						m[d] += t(255 * a), 0 > m[d] && (m[d] = 0), 255 < m[d] && (m[d] = 255);
				return this
			},
	...
	(function (a) {
		...
		A.prototype = {
			...
			applyTextShadow : function (a) {
				...
				if (H || e)
					z.textRendering = "geometricPrecision";
			...
			attr : function (a, f, L) {
				...
				(c = a, a = {}, a[c] = f);
				if ("string" === typeof a)
					e = (this[a + "Getter"] || this._defaultGetter).call(this, a, x);
				else {
					for (c in a)
						f = a[c], u = !1, this.symbolName && /^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)/.test(c) && (z || (this.symbolAttr(a), z = !0), u = !0), !this.rotation || "x" !== c && "y" !== c || (this.doTransform = !0), u || (u = this[c + "Setter"] || this._defaultSetter, u.call(this, f, c, x), this.shadows && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(c) && this.updateShadows(c, f, u));
			...
			updateShadows : function (a, f, c) {
				for (var x = this.shadows, z = x.length; z--; )
					c.call(x[z], "height" === a ? Math.max(f - (x[z].cutHeight || 0), 0) : "d" === a ? this.d : f, a, x[z])
			},
			...
			align : function (a, f, c) {
				...
				q;
				if (a) {
					if (this.alignOptions = a, this.alignByTranslate = f, !c || D(c))
						this.alignTo =
							x = c || "renderer", e(u, this), u.push(this), c = null
				} else
					a = this.alignOptions, f = this.alignByTranslate, x = this.alignTo;
				c = C(c, z[x], z);
				x = a.align;
				z = a.verticalAlign;
				u = (c.x || 0) + (a.x || 0);
			...
			destroy : function () {
				...
				if (this.stops) {
					for (x = 0; x < this.stops.length; x++)
						this.stops[x] = this.stops[x].destroy();
					this.stops = null
				}
				this.safeRemoveChild(a);
				for (this.destroyShadows(); f && f.div && 0 === f.div.childNodes.length; )
					a = f.parentGroup, this.safeRemoveChild(f.div),
					delete f.div, f = a;
			...
			shadow : function (a, f, c) {
				...
				if (!a)
					...
					for (z = 1; z <= l; z++)
						u = e.cloneNode(0), b = 2 * l + 1 - 2 * z, t(u, {
							isShadow : "true",
			...
			zIndexSetter : function (a, f) {
				...
				if (z) {
					...
					x = c.childNodes;
					for (l = 0; l < x.length && !b; l++)
						z = x[l], u = z.zIndex, z !== e && (w(u) > a || !n(a) && n(u)) && (c.insertBefore(e, z), b = !0);
					b || c.appendChild(e)
				}
				return b
			},
		...
		y.prototype = {
							...
							if ("" !== c || 1 === l.length) {
								...
								if (" " !== c) {
									...
									if (r) {
										...
										for (var p = 1 < l.length || b || 1 < C.length && !v, N, B, Q = [], T = M(w), I = a.rotation, P = c, y = P.length; (p || g) && (C.length || Q.length); )
											a.rotation = 0, N = a.getBBox(!0), B = N.width, !x && u.forExport && (B = u.measureSpanWidth(w.firstChild.data, a.styles)), N = B > r, void 0 === d && (d = N), g && d ? (y /= 2, "" === P || !N && .5 > y ? C = [] : (P = c.substring(0, P.length + (N ? -1 : 1) * Math.ceil(y)), C = [P + (3 < r ? "\u2026" : "")], w.removeChild(w.firstChild))) : N &&
			...
			text : function (a, f, c, z) {
				...
				b = {};
				if (z && (this.allowHTML || !this.forExport))
					return this.html(a, f, c);
				b.x = Math.round(f || 0);
				c && (b.y = Math.round(c));
				if (a || 0 === a)
					b.text = a;
				...
				z || (a.xSetter = function (a, f, c) {
					...
					for (b = 0; b < x.length; b++)
						z = x[b], z.getAttribute(f) === u && z.setAttribute(f, a);
					c.setAttribute(f, a)
				});
				return a
			},
			...
			label : function (a, f, c, x, z, u, b, e, l) {
				...
				X = function () {
					...
					n(r) && w && ("center" === m || "right" === m) && (a += {
						...
						(r - w.width));
					if (a !== q.x || f !== q.y)
						q.attr("x", a), void 0 !== f && q.attr("y", f);
					q.x = a;
					q.y = f
				};
				V = function (a, f) {
		...
		a.svg || (y = {
				...
				shadow : function (a, b, h) {
					...
					if (a) {
						...
						g = (a.opacity || .15) / v;
						for (q = 1; 3 >= q; q++)
							z = 2 * v + 1 - 2 * q, h && (p = this.cutOffPath(x.value, z + .5)), r = ['<shape isShadow="true" strokeweight="', z, '" filled="false" path="', p, '" coordsize="10 10" style="', d.style.cssText, '" />'], w = E(k.prepVML(r), null, {
				...
				dSetter : function (a, c, b) {
					...
					if (e)
						for (b = e.length; b--; )
							e[b].path = e[b].cutOff ? this.cutOffPath(a, e[b].cutOff) : a;
					this.setAttr(c, a)
				},
				...
				color : function (c, b, e, h) {
					...
					if (n) {
						var x,
						z,
						v = c.linearGradient || c.radialGradient,
						g,
						m,
						L,
						B,
						...
						if ("fill" === e)
							if ("gradient" === n)
								e = v.x1 || v[0] || 0, c = v.y1 || v[1] || 0, g = v.x2 || v[2] || 0, v = v.y2 || v[3] || 0, Q = 'angle="' + (90 - 180 * Math.atan((v - c) / (g - e)) / Math.PI) + '"', y();
							else {
								var p = v.r,
								A = 2 * p,
								G = 2 * p,
						...
						d.test(c) && "IMG" !== b.tagName ? (q = a.color(c), h[e + "-opacitySetter"](q.get("a"), e, b), p = q.get("rgb")) : (p = b.getElementsByTagName(e), p.length && (p[0].opacity = 1, p[0].type =
									"solid"), p = c);
					return p
				},
				prepVML : function (a) {
	...
	(function (a) {
		...
		a.PlotLineOrBand.prototype = {
			render : function () {
				...
				if (q)
					u = n.getPlotLinePath(c, h.strokeWidth());
				else if (l)
					u = n.getPlotBandPath(e, g, b);
				else
					return;
				if (f && u && u.length) {
					if (h.attr({
		...
		a.AxisPlotLineOrBandExtension = {
			...
			removePlotBandOrLine : function (a) {
				for (var d = this.plotLinesAndBands, p = this.options, b = this.userOptions, k = d.length; k--; )
	...
	(function (a) {
		...
		a.Tick.prototype = {
			...
			handleOverflow : function (a) {
				...
				D = {};
				if (e)
					0 > e && p - c * l < v ? u = Math.round(p / Math.cos(e * m) - v) : 0 < e && p + c * l > k && (u = Math.round((b - p) / Math.cos(e * m)));
				else if (b = p + (1 - c) * l, p - c * l < v ? h = a.x + h * (1 - c) - v : b > k && (h = k - a.x + h * c, f = -1), h = Math.min(q, h), h < q && "center" === d.labelAlign && (a.x += f * (q - h - c * (q - Math.min(l, h)))), l > h || d.autoRotation && (B.styles || {}).width)
					u = h;
			...
			render : function (a, n, p) {
				...
				if (!n && h && (l = b.getPlotLinePath(l + w, h.strokeWidth() * x, n, !0)))
		...
		a.Axis.prototype = {
			...
			defaultLabelFormatter : function () {
				...
				if (u)
					...
					for (; q-- &&
						void 0 === d; )
						f = Math.pow(1E3, q + 1), c >= f && 0 === 10 * b % f && null !== l[q] && 0 !== b && (d = a.numberFormat(b / f, -1) + l[q]);
			...
			getSeriesExtremes : function () {
				...
				b(a.series, function (b) {
					if (b.visible || !c.options.chart.ignoreHiddenSeries) {
						...
						0 >= h && (h = null);
						if (a.isXAxis)
							e = b.xData, e.length && (b = G(e), f(b) || b instanceof Date || (e = l(e, function (a) {
											return f(a)
										}), b = G(e)), a.dataMin = Math.min(F(a.dataMin, e[0]), b), a.dataMax = Math.max(F(a.dataMax, e[0]), E(e)));
						else if (b.getExtremes(), d = b.dataMax, b = b.dataMin, r(b) && r(d) && (a.dataMin = Math.min(F(a.dataMin, b), b), a.dataMax = Math.max(F(a.dataMax, d), d)), r(h) && (a.threshold = h), !e.softThreshold || a.isLog)
							a.softThreshold = !1
					}
				})
			},
			...
			getPlotLinePath : function (a,
				...
				u,
				k,
				w = b && l.oldChartHeight || l.chartHeight,
				C = b && l.oldChartWidth || l.chartWidth,
				p;
				u = this.transB;
				var v = function (a, c, b) {
					if (a < c || a > b)
						e ? a = Math.min(Math.max(c, a), b) : p = !0;
					return a
				};
			...
			getMinorTickPositions : function () {
				...
				if (l && l / b < this.len / 3)
					if (this.isLog)
						for (h = c.length, e = 1; e < h; e++)
							f = f.concat(this.getLogTickPositions(b, c[e - 1], c[e], !0));
					else if (this.isDatetimeAxis && "auto" === a.minorTickInterval)
						f = f.concat(this.getTimeTicks(this.normalizeTimeTickInterval(b),
									e, h, a.startOfWeek));
					else
						for (c = e + (c[0] - e) % b; c <= h; c += b)
							f.push(c);
			...
			setAxisTranslation : function (a) {
				...
				C = c.isXAxis;
				if (C || k || e)
					q ? (l = q.minPointOffset, d = q.pointRangePadding) : (h = c.getClosest(), b(c.series, function (a) {
			...
			adjustTickAmount : function () {
				...
				if (f < b) {
					for (; c.length < b; )
						c.push(d(c[c.length - 1] + a));
					this.transA *= (f - 1) / (b - 1);
					this.max = c[c.length - 1]
				} else
					f > b && (this.tickInterval *= 2, this.setTickPositions());
				if (r(e)) {
					for (a = b = c.length; a--; )
			...
			setScale : function () {
				...
				b(this.series, function (c) {
					if (c.isDirtyData || c.isDirty || c.xAxis.isDirty)
						a = !0
				});
			...
			tickSize : function (a) {
				...
				if (e && b)
					return "inside" === c[a + "Position"] && (b = -b), [b, e]
			},
			...
			unsquish : function () {
				...
				c ? (w = !a.staggerLines && !a.step && (r(d) ? [d] : h < F(a.autoRotationLimit, 80) && a.autoRotation)) && b(w, function (a) {
					var c;
					if (a === d || a && -90 <= a && 90 >= a)
						u = C(Math.abs(q.h / Math.sin(n * a))), c = u + Math.abs(a / 360), c < k && (k = c, l = a, f = u)
				}) : a.step || (f = C(q.h));
				this.autoRotation = w;
			...
			render : function () {
				...
				if (a.hasData() || q)
					a.minorTickInterval && !a.categories && b(a.getMinorTickPositions(), function (c) {
						...
						C[c].render(null, !1, 1)
							...
							if (!q || c >= a.min && c <= a.max)
								w[c] || (w[c] = new M(a, c)), n && w[c].isNew && w[c].render(b, !0, .1), w[c].render(b)
				...
				b([w, C, p], function (a) {
					...
					h = r.duration;
					for (b in a)
						a[b].isActive || (a[b].render(b, !1, 0), a[b].isActive = !1, f.push(b));
					J(function () {
						for (e = f.length; e--; )
							a[f[e]] && !a[f[e]].isActive &&
			...
			destroy : function (a) {
				...
				for (l in c)
					c.hasOwnProperty(l) && -1 === q(l, h) && delete c[l]
			},
	...
	(function (a) {
		...
		function (a, d, n, e) {
			...
			if (G(d)) {
				...
				if (D >= b.second)
					f[y.hcSetSeconds](D >= b.minute ? 0 : H * Math.floor(f.getSeconds() / H));
				if (D >= b.minute)
					f[y.hcSetMinutes](D >= b.hour ? 0 : H * Math.floor(f[y.hcGetMinutes]() / H));
				if (D >= b.hour)
					f[y.hcSetHours](D >= b.day ? 0 : H * Math.floor(f[y.hcGetHours]() / H));
				if (D >= b.day)
					f[y.hcSetDate](D >= b.month ? 1 : H * Math.floor(f[y.hcGetDate]() / H));
				D >=
				b.month && (f[y.hcSetMonth](D >= b.year ? 0 : H * Math.floor(f[y.hcGetMonth]() / H)), h = f[y.hcGetFullYear]());
				if (D >= b.year)
					f[y.hcSetFullYear](h - h % H);
				if (D === b.week)
					f[y.hcSetDate](f[y.hcGetDate]() - f[y.hcGetDay]() + p(e, 1));
				d = 1;
				if (y.hcTimezoneOffset || y.hcGetTimezoneOffset)
					f = f.getTime(), f = new y(f + m(f));
				h = f[y.hcGetFullYear]();
				e = f.getTime();
				for (var F = f[y.hcGetMonth](), I = f[y.hcGetDate](), C = !q || !!y.hcGetTimezoneOffset, w = (b.day + (q ? m(f) : 6E4 * f.getTimezoneOffset())) % b.day; e < n; )
					c.push(e), e = D === b.year ? u(h + d * H, 0) : D === b.month ?
	...
	(function (a) {
		...
		A.prototype.getLogTickPositions = function (a, d, m, r) {
			...
			if (.5 <= a)
				a = Math.round(a), v = this.getLinearTickPositions(a,
						d, m);
			else if (.08 <= a)
				for (var p = Math.floor(d), B, e, c, l, q, n = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; p < m + 1 && !q; p++)
					for (e = n.length, B = 0; B < e && !q; B++)
						c = k(b(p) * n[B]), c > d && (!r || l <= m) && void 0 !== l && v.push(l), l > m && (q = !0), l = c;
			else
				d = b(d), m = b(m), a = n[r ? "minorTickInterval" : "tickInterval"], a = t("auto" === a ? null : a, this._minorAutoInterval, n.tickPixelInterval / (r ? 5 : 1) * (m - d) / ((r ? p / this.tickPositions.length : p) || 1)), a = G(a, null, y(a)), v = E(this.getLinearTickPositions(a, d, m), k), r || (this._minorAutoInterval = a / 5);
			r || (this.tickInterval =
					a);
			return v
		};
	...
	(function (a) {
		...
		a.Tooltip.prototype = {
			...
			getPosition : function (a, b, e) {
				...
				h = e.h || 0,
				f,
				u = ["y", c.chartHeight, b, e.plotY + c.plotTop, c.plotTop, c.plotTop + c.plotHeight],
				...
				g = function (a, c, b, e, f, u) {
					...
					if (p && w)
						...
						d[a] = Math.min(u - b, 0 > C - h ? C : C - h);
					else if (w)
						d[a] = Math.max(f, e + h + b > c ? e : e + h);
					else
						return !1
				},
				n = function (a, c, b, e) {
			...
			getXDateFormat : function (a, b, e) {
				...
				if (l) {
					...
					for (d in k) {
						...
						if (h[d] && f.substr(h[d]) !== "01-01 00:00:00.000".substr(h[d]))
							break;
						"week" !== d && (u = d)
					}
					d && (c = b[d])
	...
	(function (a) {
		...
		a.Pointer.prototype = {
			...
			runPointActions : function (c) {
				...
				if (!f && !p)
					for (g = 0; g < q.length; g++)
						if (q[g].directTouch || !q[g].options.stickyTracking)
							q = [];
				...
				if (f)
					for (g = w.length; g--; )
						(w[g].clientX !== w[0].clientX || w[g].series.noSharedTooltip) && w.splice(g, 1);
				if (w[0] && (w[0] !== this.hoverPoint || h && h.isHidden)) {
					if (f && !w[0].series.noSharedTooltip) {
						for (g = 0; 0 <= g; g--)
							w[g].onMouseOver(c, w[g] !== (p && p.directTouch &&
									k || w[0]));
						if (p && p.directTouch && k && k !== w[0])
							k.onMouseOver(c, !1);
						w.length && h && h.refresh(w.sort(function (a, c) {
								return a.series.index - c.series.index
							}), c)
					} else if (h && h.refresh(w[0], c), !p || !p.directTouch)
						w[0].onMouseOver(c);
					this.prevKDPoint = w[0];
					u = !1
				}
				u && (q = p && p.tooltipOptions.followPointer, h && q && !h.isHidden && (q = h.getAnchor([{}
								], c), h.updatePosition({
							plotX : q[0],
							plotY : q[1]
						})));
				this._onDocumentMouseMove || (this._onDocumentMouseMove = function (c) {
					if (E[a.hoverChartIndex])
						E[a.hoverChartIndex].pointer.onDocumentMouseMove(c)
				},
			...
			reset : function (a, b) {
				...
				if (a)
					p && g && (p.refresh(g), f && (f.setState(f.state, !0), m(e.axes, function (a) {
				...
				"touchstart" === a.type ? (y(p, function (a, c) {
						...
						if (a.zoomEnabled) {
							...
							c.max = Math.max(a.pos + a.len, l + b)
								...
								destroy : t,
								touch : !0
							}, r.plotBox)), m.pinchTranslate(n, p, e, B, l, k), m.hasPinched = v, m.scaleGroups(e, l), !v && m.followTouchMove && 1 === b ? this.runPointActions(m.normalize(a)) : m.res && (m.res =
							!1, this.reset(!1, 0)))
			},
			touch : function (d, m) {
				var r = this.chart,
	...
	(function (a) {
		...
		S.prototype = {
			...
			redraw : function (b) {
				...
				if (u)
					for (q = C; q--; )
						b = f[q], b.options.stacking && (b.isDirty = !0);
				k(f, function (a) {
					a.isDirty &&
			...
			cloneRenderTo : function (a) {
				...
				if (a) {
					...
					c && c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), p(b, {
						position : "absolute",
						top : "-9999px",
						display : "block"
			...
			reflow : function (a) {
				...
				if (!d && !e.isPrinting && k && f && (h === N || h === t)) {
					if (k !== e.containerWidth || f !== e.containerHeight)
						clearTimeout(e.reflowTimeout), e.reflowTimeout = z(function () {
			...
			propFromSeries : function () {
				...
				k(["inverted", "angular", "polar"], function (d) {
					...
					for (f = e && e.length; !h && f--; )
						(c = J[e[f].type]) && c.prototype[d] && (h = !0);
					a[d] = h
				})
			},
			linkSeries : function () {
		...
		A.prototype = {
			...
			optionsToObject : function (a) {
				...
				if (m(a) || null === a)
					...
					for (!g &&
						a.length > e && (k = typeof a[0], "string" === k ? b.name = a[0] : "number" === k && (b.x = a[0]), c++); l < e; )
						g && void 0 === a[c] || (b[n[l]] = a[c]), c++, l++;
				else
					"object" === typeof a && (b = a, a.dataLabels && (k._hasPointLabels = !0), a.marker && (k._hasPointMarkers = !0));
				return b
			},
			...
			destroyElements : function () {
				for (var a = ["graphic",
						"dataLabel", "dataLabelUpper", "connector", "shadowGroup"], b, d = 6; d--; )
	...
	(function (a) {
		...
		a.Series = a.seriesType("line", null, {
				...
				setData : function (a,
					...
					q = a.length;
					f = h(f, !0);
					if (!1 !== k && q && p === q && !g.cropped && !g.hasGroupedData && g.visible)
						n(a, function (a, b) {
						...
						if (t && q > t) {
							...
							if (c(v))
								...
								if (B)
									for (d = 0; d < q; d++)
										v = a[d], F[d] = v[0], H[d] = v.slice(1, B + 1);
								else
									for (d = 0; d < q; d++)
										v = a[d], F[d] = v[0], H[d] = v[1];
							else
								b(12)
						} else
							for (d = 0; d < q; d++)
				...
				processData : function (a) {
					...
					m,
					v;
					if (q && !this.isDirty && !l.isDirty && !this.yAxis.isDirty && !a)
						return !1;
					l && (a = l.getExtremes(), m = a.min, v = a.max);
					if (q && this.sorted && !p && (!g || f > g || this.forceCrop))
						if (c[f - 1] < m || c[0] > v)
							c = [], e = [];
						else if (c[0] < m || c[f - 1] > v)
							d = this.cropData(this.xData,
									this.yData, m, v), c = d.xData, e = d.yData, d = d.start, h = !0;
					for (g = c.length || 1; --g; )
						f = n ? u(c[g]) - u(c[g - 1]) : c[g] - c[g - 1], 0 < f && (void 0 === k || f < k) ? k = f : 0 > f && this.requireSorting && b(15);
					this.cropped = h;
					this.cropStart = d;
				...
				generatePoints : function () {
					...
					for (n = 0; n < h; n++)
						l = k + n, g ? (q[n] = (new d).init(this, [e[n]].concat(u(f[n]))), q[n].dataGroup = this.groupMap[n]) : (b[l] ? p = b[l] : void 0 !== a[l] && (b[l] = p = (new d).init(this, a[l], e[n])), q[n] = p), q[n].index = l;
					if (b && (h !== (c = b.length) || g))
						for (n = 0; n < c; n++)
							n !== k || g || (n += h), b[n] && (b[n].destroyElements(), b[n].plotX = void 0);
					this.data = b;
					this.points = q
				},
				...
				drawPoints : function () {
					...
					if (!1 !== q.enabled || this._hasPointMarkers)
						for (d = a.length; d--; )
							l = a[d], e = Math.floor(l.plotX), f = l.plotY, n = l.graphic, m = l.marker || {},
					v = !!l.marker,
	...
	(function (a) {
		...
		A.prototype = {
			...
			setOffset : function (a, d) {
				...
				if (g = this.label)
					g.align(this.alignOptions, null, m), m = g.alignAttr, g[!1 === this.options.crop || k.isInsidePlot(m.x, m.y) ? "show" : "hide"](!0)
			}
		};
		...
		y.prototype.buildStacks = function () {
			...
			if (!this.isXAxis) {
				...
				for (g = k; g--; )
					a[b ? g : k - g - 1].setStackedPoints();
				for (g = k; g--; )
					d = a[b ? g : k - g - 1], d.setStackCliffs && d.setStackCliffs();
		...
		y.prototype.resetStacks = function () {
			...
			if (!this.isXAxis)
				for (d in a)
					for (b in a[d])
						a[d][b].touched < this.stacksTouched ? (a[d][b].destroy(), delete a[d][b]) : (a[d][b].total = null, a[d][b].cum = 0)
		};
		...
		a.prototype.setPercentStacks = function () {
			...
			d([g, "-" + g], function (d) {
				for (var e = k.length, c, g; e--; )
					if (c = k[e], m = a.getStackIndicator(m, c, a.index), c = (g = b[d] && b[d][c]) && g.points[m.key])
						g = g.total ? 100 / g.total : 0, c[0] = G(c[0] * g), c[1] = G(c[1] * g), a.stackedYData[e] = c[1]
			})
		};
	...
	(function (a) {
		...
		r(a.Chart.prototype, {
			...
			update : function (a, b) {
				...
				if (l) {
					...
					for (c in l)
						l.hasOwnProperty(c) && (-1 !== p("chart." + c, this.propsRequireUpdateSeries) && (n = !0), -1 !== p(c, this.propsRequireDirtyBox) && (this.isDirtyBox = !0));
					"style" in l && this.renderer.setStyle(l.style)
				}
				for (c in a) {
					if (this[c] && "function" === typeof this[c].update)
						this[c].update(a[c], !1);
					else if ("function" === typeof this[e[c]])
						this[e[c]](a[c]);
		...
		r(E.prototype, {
			...
			remove : function (a) {
				for (var b = this.chart, c = this.coll, e = this.series, g = e.length; g--; )
					e[g] && e[g].remove(!1);
				m(b.axes, this);
				m(b[c], this);
		...
		g("area", "line", {
			...
			getStackPoints : function () {
				...
				if (this.options.stacking) {
					...
					y(g, function (f, h) {
						...
						F;
						if (b[f] && !b[f].isNull)
							a.push(b[f]), y([-1, 1], function (a) {
								var d = 1 === a ? "rightNull" : "leftNull",
								k = 0,
								n = p[g[h + a]];
								if (n)
									for (q = v; 0 <= q && q < e; )
										t = n.points[q], t || (q === v ? b[f][d] = !0 : c[q] && (F = p[f].points[q]) && (k -= F[1] - F[0])), q += l;
			...
			getGraphPath : function (a) {
				...
				for (b = 0; b < a.length; b++)
					if (k = a[b].isNull, c = G(a[b].rectPlotX, a[b].plotX), f = G(a[b].yBottom, h), !k || r)
						r || u(b, b - 1, "left"), k && !n && r || (B.push(a[b]), v.push({
								x : b,
								plotX : c,
								plotY : f
							})), r || u(b, b + 1, "right");
			...
			drawGraph : function () {
				...
				g = this.areaPath,
				r = this.options,
				n = [["area", "highcharts-area", this.color,
						r.fillColor]];
	...
	(function (a) {
		...
		a.CenteredSeriesMixin = {
			getCenter : function () {
				...
				n;
				for (r = 0; 4 > r; ++r)
					n = d[r], a = 2 > r || 2 === r && /%$/.test(n), d[r] = y(n, [g, G, m, d[2]][r]) + (a ? t : 0);
				d[3] > d[2] && (d[3] = d[2]);
				return d
			}
		}
	...
	(function (a) {
		...
		n("pie", "line", {
			...
			updateTotals : function () {
				...
				for (a = 0; a < m; a++)
					e = g[a], 0 > e.y && (e.y = null), d += c && !e.visible ? 0 : e.y;
				this.total = d;
				for (a = 0; a < m; a++)
					e = g[a], e.percentage = 0 < d && (e.visible || !c) ? e.y / d * 100 : 0, e.total = d
			},
			generatePoints : function () {
	...
	(function (a) {
		...
		a.distribute = function (a, b) {
			...
			for (a = d(a, function (a) {
				...
				for (k = a.length; k--; )
					h = a[k], n = (Math.min.apply(0, h.targets) + Math.max.apply(0, h.targets)) /
					2, h.pos = Math.min(Math.max(0, n - h.size / 2), b - h.size);
				k = a.length;
				for (h = !1; k--; )
					0 < k && a[k - 1].pos + a[k - 1].size > a[k].pos && (a[k - 1].size += a[k].size, a[k - 1].targets = a[k - 1].targets.concat(a[k].targets), a[k - 1].pos + a[k - 1].size > b && (a[k - 1].pos = b - a[k - 1].size), a.splice(k, 1), h = !0)
			}
			k = 0;
			G(a, function (a) {
				var b = 0;
		...
		b.prototype.drawDataLabels = function () {
			...
			if (d.enabled || a._hasPointLabels)
				a.dlProcessOptions && a.dlProcessOptions(d), r = a.plotGroup("dataLabelsGroup", "data-labels", v && !u ? "hidden" : "visible", d.zIndex || 6), v && (r.attr({
						opacity : +u
			...
			e.visible && (h.enabled || e._hasPointLabels) && (b.prototype.drawDataLabels.apply(e), G(c, function (a) {
					...
					if (u)
						for (e.sortByAngle(b, c - .5), 0 < v && (m = Math.max(0, B - w - v), n = Math.min(B + w + v, k.plotHeight), t = d(b, function (a) {
										if (a.dataLabel)
											return F = a.dataLabel.getBBox().height || 21, {
												target : a.labelPos[1] - m + F / 2,
												size : F,
												rank : a.y
											}
									}),
								a.distribute(t, n + F - m)), Q = 0; Q < u; Q++)
							g = b[Q], E = g.labelPos, x = g.dataLabel, T = !1 === g.visible ? "hidden" : "inherit", y = E[1], t ? void 0 === t[Q].pos ? T = "hidden" : (K = t[Q].size, R = m + t[Q].pos) : R = y, L = h.justify ? C[0] + (c ? -1 : 1) * (w + v) : e.getX(R < m + 2 || R > n - 2 ? y : R, c), x._attr = {
								visibility : T,
								align : E[6]
							},
					x._pos = {
					...
					E.x = L,
					E.y = R,
					null === e.options.size && (z = x.width, L - z < f ? P[3] = Math.max(Math.round(z - L + f), P[3]) : L + z > p - f && (P[1] = Math.max(Math.round(L + z - p + f), P[1])), 0 > R - K / 2 ? P[0] = Math.max(Math.round(-R +
					...
					if ((x = a.dataLabel) && x._pos && a.visible) {
						...
						if (b = !t)
							a.connector = t = k.renderer.path().addClass("highcharts-data-label-connector highcharts-color-" + a.colorIndex).add(e.dataLabelsGroup), t.attr({
								"stroke-width" : m,
			...
			for (m = 0; m < g; m++)
				for (r = a[m], d = m + 1; d < g; ++d)
					if (n = a[d], r && n && r.placed && n.placed && 0 !== r.newOpacity && 0 !== n.newOpacity && (p = r.alignAttr, b = n.alignAttr, k = r.parentGroup, v = n.parentGroup,
							B = 2 * (r.box ? 0 : r.padding), p = e(p.x + k.translateX, p.y + k.translateY, r.width - B, r.height - B, b.x + v.translateX, b.y + v.translateY, n.width - B, n.height - B)))
	...
	(function (a) {
		...
		m(y.prototype, {
			...
			zoom : function (a) {
				...
				!a || a.resetSelection ? d(this.axes, function (a) {
					...
					var b = a.axis,
					d = b.isXAxis;
					if (e[d ? "zoomX" : "zoomY"] || e[d ? "pinchX" : "pinchY"])
					...
					r && r.hide();
						...
						if (a && p) {
							...
							if (r)
								...
								p && (e.stateMarkerGraphic = r = y.renderer.symbol(p, c - l, d - l, 2 * l, 2 * l).add(e.markerGroup), r.currentSymbol = p);
		...
		m(c.prototype, {
			...
			setVisible : function (a, b) {
				...
				g = c.legendItem,
				k,
				l = e.options.chart.ignoreHiddenSeries,
				m = c.visible;
			...
			function m(a, d, b) {
				...
				for (k in a)
					if (-1 <
						...
						for (a[k] = g(a[k]), b[k] = [], r = 0; r < a[k].length; r++)
							b[k][r] = {},
				m(a[k][r], d[k][r], b[k][r]);
				else
					G(a[k]) ? (b[k] = {}, m(a[k], d[k] || {}, b[k])) : b[k] = d[k] || null
			}
			var r = {};
			m(a, this.options, r);
			return r
